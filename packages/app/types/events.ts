...
export interface ScheduleItem {
  ...
  speakers?: Speaker[]
  type: 'talk' | 'service' | 'meal' | 'activity' | 'break' | 'arrival' | 'welcome' | 'other'
  notes?: string
}
...
export interface GeneralEvent extends BaseEvent {
  ...
  endDate?: Date
  hostingEcclesia?: HostingEcclesiaDetails
  location?: LocationDetails // Single location (legacy support)
  locations?: (LocationDetails & { type?: string })[] // Multiple locations (new)
  speakers?: Speaker[]
  schedule?: ScheduleItem[]
  registration?: RegistrationDetails
  documents?: DocumentAttachment[]
