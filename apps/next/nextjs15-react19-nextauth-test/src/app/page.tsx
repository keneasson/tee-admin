    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">React 19 + NextAuth.js v5</h1>
          <h2 className="text-lg font-semibold text-green-600 mb-6">✅ Compatibility Test</h2>
          ...
          {session ? (
            <div className="space-y-4">
              <div className="bg-green-50 border border-green-200 rounded-md p-4">
                ...
                <p className="text-green-700">User: {session.user?.email}</p>
