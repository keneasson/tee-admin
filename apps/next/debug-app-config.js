...
try {
  ...
  console.log('   Access Key ID:', config.credentials?.accessKeyId ? `${config.credentials.accessKeyId.substring(0, 10)}...` : 'NOT SET')
  console.log('   Secret Access Key:', config.credentials?.secretAccessKey ? `${config.credentials.secretAccessKey.substring(0, 10)}...` : 'NOT SET')
} catch (error) {
